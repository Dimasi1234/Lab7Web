...
3. **View dan Layout:**
   - Buat view `about.php`, `contact.php`, dll.
   - Buat `template/header.php` dan `template/footer.php`
   - Include header & footer di setiap halaman.

4. **CSS Layout:**
   - Tambahkan `style.css` ke folder `public`.
   - Gunakan layout praktikum 4.

### Screenshot
> **(Tambahkan screenshot hasil tampilan di browser di bagian ini)**

### Repository
- Repository ini berisi hasil praktikum modul 1 CodeIgniter.
- URL: `https://github.com/username/Lab7Web`
```
